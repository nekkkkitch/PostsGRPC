...
func (c *authClient) Register(ctx context.Context, in *LoginData, opts ...grpc.CallOption) (*AuthData, error) {
	out := new(AuthData)
...
func (c *authClient) Login(ctx context.Context, in *LoginData, opts ...grpc.CallOption) (*AuthData, error) {
	out := new(AuthData)
...
func (c *authClient) Refresh(ctx context.Context, in *AuthData, opts ...grpc.CallOption) (*AuthData, error) {
	out := new(AuthData)
...
func (UnimplementedAuthServer) Register(context.Context, *LoginData) (*AuthData, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedAuthServer) Login(context.Context, *LoginData) (*AuthData, error) {
...
func _Auth_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Register(ctx, req.(*LoginData))
	}
...
func _Auth_Refresh_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Refresh(ctx, req.(*AuthData))
	}
	return interceptor(ctx, in, info, handler)
}
